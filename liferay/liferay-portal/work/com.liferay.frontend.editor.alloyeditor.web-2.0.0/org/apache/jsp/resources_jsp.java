...
String editorName = (String)request.getAttribute(AlloyEditorConstants.ATTRIBUTE_NAMESPACE + ":editorName");
	...
	long javaScriptLastModified = PortalWebResourcesUtil.getLastModified(PortalWebResourceConstants.RESOURCE_TYPE_EDITOR_ALLOYEDITOR);
          ...
          out.write("\t\t\treturn CKEDITOR.dialog._.currentZIndex ? CKEDITOR.dialog._.currentZIndex + 10 : Liferay.zIndex.WINDOW + 10;\n");
          out.write("\t\t};\n");
          out.write("\n");
          out.write("\t\tvar destroyGlobalEditors = function() {\n");
          out.write("\t\t\twindow.AlloyEditor = undefined;\n");
          out.write("\t\t\twindow.CKEDITOR = undefined;\n");
          out.write("\n");
          out.write("\t\t\tLiferay.detach('beforeScreenFlip', destroyGlobalEditors);\n");
          out.write("\t\t};\n");
          out.write("\n");
          out.write("\t\tLiferay.on('beforeScreenFlip', destroyGlobalEditors);\n");
          out.write("\t</script>\n");
