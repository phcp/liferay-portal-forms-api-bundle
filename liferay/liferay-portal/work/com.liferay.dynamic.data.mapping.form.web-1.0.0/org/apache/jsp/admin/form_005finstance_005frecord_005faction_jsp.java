...
DDMFormInstanceRecord formInstanceRecord = (DDMFormInstanceRecord)row.getObject();
      ...
      if (_jspx_eval_liferay$1ui_icon$1menu_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write('	');
if (
 ddmFormAdminDisplayContext.isShowViewEntriesFormInstanceIcon(ddmFormAdminDisplayContext.getDDMFormInstance()) ) {
          out.write("\n");
          out.write("\t\t");
          //  portlet:renderURL
          ...
          out.write("\t");
if (
 ddmFormAdminDisplayContext.isShowDeleteFormInstanceIcon(ddmFormAdminDisplayContext.getDDMFormInstance()) ) {
          out.write("\n");
          out.write("\t\t");
          //  portlet:actionURL
