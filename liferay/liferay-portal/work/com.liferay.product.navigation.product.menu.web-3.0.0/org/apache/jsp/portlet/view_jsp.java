...
String productMenuState = SessionClicks.get(request, ProductNavigationProductMenuWebKeys.PRODUCT_NAVIGATION_PRODUCT_MENU_STATE, "closed");
      ...
      out.write("\n");
      out.write("\n");
      out.write("<div class=\"lfr-product-menu-sidebar\" id=\"productMenuSidebar\">\n");
      out.write("\t<div class=\"sidebar-header\">\n");
      out.write("\t\t<div class=\"sidebar-section-flex\">\n");
      out.write("\t\t\t<div class=\"flex-col flex-col-expand\">\n");
      out.write("\t\t\t\t<a href=\"");
      out.print( PortalUtil.addPreservedParameters(themeDisplay, themeDisplay.getURLPortal(), false, true) );
      out.write("\">\n");
      out.write("\t\t\t\t\t<span class=\"company-details truncate-text\">\n");
      ...
      out.write("\t\t");
if (
 Objects.equals(productMenuState, "open") ) {
      out.write("\n");
      out.write("\t\t\t");
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("\tvar sidenavToggle = $('#");
          if (_jspx_meth_portlet_namespace_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("sidenavToggleId');\n");
          out.write("\n");
          out.write("\tsidenavToggle.sideNavigation();\n");
          out.write("\n");
          out.write("\tLiferay.once(\n");
          out.write("\t\t'screenLoad',\n");
          out.write("\t\tfunction() {\n");
          out.write("\t\t\tvar sideNavigation = sidenavToggle.data('lexicon.sidenav');\n");
          out.write("\n");
          out.write("\t\t\tif (sideNavigation) {\n");
          out.write("\t\t\t\tsideNavigation.destroy();\n");
          out.write("\t\t\t}\n");
          out.write("\t\t}\n");
          out.write("\t);\n");
          out.write("\n");
          out.write("\tvar sidenavSlider = $('#");
          if (_jspx_meth_portlet_namespace_1((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("sidenavSliderId');\n");
          out.write("\n");
          out.write("\tsidenavSlider.on(\n");
          out.write("\t\t'closed.lexicon.sidenav',\n");
          ...
          out.write("\n");
          out.write("\tsidenavSlider.on(\n");
          out.write("\t\t'open.lexicon.sidenav',\n");
          out.write("\t\tfunction(event) {\n");
          out.write("\t\t\tLiferay.Store('");
          out.print( ProductNavigationProductMenuWebKeys.PRODUCT_NAVIGATION_PRODUCT_MENU_STATE );
          out.write("', 'open');\n");
          ...
          out.write("\t);\n");
          out.write("\n");
          out.write("\tif (Liferay.Util.isPhone() && ($('body').hasClass('open'))) {\n");
          out.write("\t\tsidenavToggle.sideNavigation('hide');\n");
          out.write("\t}\n");
          out.write("\n");
          out.write("\t");
if (
 productMenuDisplayContext.hasUserPanelCategory() ) {
          out.write("\n");
          out.write("\t\tLiferay.on(\n");
          out.write("\t\t\t'ProductMenu:openUserMenu',\n");
          out.write("\t\t\tfunction(event) {\n");
          out.write("\t\t\t\tvar userCollapseSelector = '#");
          if (_jspx_meth_portlet_namespace_2((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.print( AUIUtil.normalizeId(PanelCategoryKeys.USER) );
          out.write("Collapse';\n");
          out.write("\n");
          out.write("\t\t\t\tvar showUserCollapse = function() {\n");
          out.write("\t\t\t\t\tvar userCollapse = $(userCollapseSelector);\n");
          out.write("\n");
          out.write("\t\t\t\t\tuserCollapse.collapse(\n");
          out.write("\t\t\t\t\t\t{\n");
          out.write("\t\t\t\t\t\t\tparent: '#");
          ...
          out.write("\t\t\t\t\t);\n");
          out.write("\n");
          out.write("\t\t\t\t\tuserCollapse.collapse('show');\n");
          out.write("\t\t\t\t};\n");
          out.write("\n");
          out.write("\t\t\t\tif ($('body').hasClass('open')) {\n");
          out.write("\t\t\t\t\tif ($(userCollapseSelector).hasClass('in')) {\n");
          out.write("\t\t\t\t\t\tsidenavToggle.sideNavigation('hide');\n");
          out.write("\t\t\t\t\t}\n");
          out.write("\t\t\t\t\telse {\n");
          out.write("\t\t\t\t\t\tshowUserCollapse();\n");
          out.write("\t\t\t\t\t}\n");
          out.write("\t\t\t\t}\n");
          out.write("\t\t\t\telse {\n");
          out.write("\t\t\t\t\tsidenavToggle.sideNavigation('show');\n");
          out.write("\n");
          out.write("\t\t\t\t\tif (!sidenavToggle.attr('data-url')) {\n");
          out.write("\t\t\t\t\t\tshowUserCollapse();\n");
          out.write("\t\t\t\t\t}\n");
          out.write("\t\t\t\t\telse {\n");
          out.write("\t\t\t\t\t\tvar urlLoadedState = sidenavSlider.data('url-loaded') ? sidenavSlider.data('url-loaded').state() : '';\n");
          out.write("\n");
          out.write("\t\t\t\t\t\tif (urlLoadedState === 'resolved') {\n");
          out.write("\t\t\t\t\t\t\tshowUserCollapse();\n");
          out.write("\t\t\t\t\t\t}\n");
          out.write("\t\t\t\t\t\telse {\n");
          out.write("\t\t\t\t\t\t\tsidenavSlider.on(\n");
          out.write("\t\t\t\t\t\t\t\t'urlLoaded.lexicon.sidenav',\n");
          out.write("\t\t\t\t\t\t\t\tfunction(event) {\n");
          out.write("\t\t\t\t\t\t\t\t\tshowUserCollapse();\n");
          out.write("\t\t\t\t\t\t\t\t}\n");
          out.write("\t\t\t\t\t\t\t);\n");
