...
if (
 !panelApps.isEmpty() && showHeader ) {
      ...
      out.write(" list-group-heading\" data-qa-id=\"appGroup\" data-toggle=\"collapse\" href=\"#");
      out.print( id );
      out.write("\">\n");
      out.write("\t\t");
if (
 !panelCategory.includeHeader(request, PipingServletResponse.createPipingServletResponse(pageContext)) ) {
      out.write("\n");
      out.write("\t\t\t");
...
if (
 notificationsCount > 0 ) {
      out.write("\n");
      out.write("\t\t\t\t<span class=\"panel-notifications-count sticker sticker-right sticker-rounded sticker-sm sticker-warning\" data-qa-id=\"notificationsCount\">");
