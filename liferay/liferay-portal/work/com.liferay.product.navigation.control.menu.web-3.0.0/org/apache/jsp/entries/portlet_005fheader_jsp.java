...
String portletTitle = (String)request.getAttribute(ProductNavigationControlMenuWebKeys.PORTLET_TITLE);
      ...
      out.write("\t<span class=\"control-menu-level-1-heading truncate-text\" data-qa-id=\"headerTitle\">");
      out.print( HtmlUtil.escape(portletTitle) );
      out.write("</span>\n");
      out.write("\n");
      out.write("\t");
if (
 Validator.isNotNull(portletDescription) ) {
      out.write("\n");
      out.write("\t\t");
      ...
      _jspx_th_liferay$1ui_icon$1help_0.setMessage( HtmlUtil.escape(portletDescription) );
