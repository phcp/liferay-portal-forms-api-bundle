...
addPanelURL.setWindowState(LiferayWindowState.EXCLUSIVE);
      ...
      out.write("\t<a class=\"control-menu-icon lfr-portal-tooltip product-menu-toggle sidenav-toggler\" data-content=\"body\" data-open-class=\"open-admin-panel\" data-qa-id=\"add\" data-target=\"#");
      out.print( portletNamespace );
      out.write("addPanelId\" data-title=\"");
      out.print( HtmlUtil.escape(LanguageUtil.get(request, "add")) );
