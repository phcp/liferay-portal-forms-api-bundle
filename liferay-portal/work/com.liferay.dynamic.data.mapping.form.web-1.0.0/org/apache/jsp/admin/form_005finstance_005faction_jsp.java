...
DDMFormInstance formInstance = (DDMFormInstance)row.getObject();
      ...
      if (_jspx_eval_liferay$1ui_icon$1menu_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write('	');
if (
 ddmFormAdminDisplayContext.isShowCopyURLFormInstanceIcon(formInstance) && ddmFormAdminDisplayContext.isFormPublished(formInstance) ) {
          out.write("\n");
          out.write("\t\t");
          //  liferay-ui:icon
          ...
          out.write("\t");
if (
 ddmFormAdminDisplayContext.isShowViewEntriesFormInstanceIcon(formInstance) ) {
          out.write("\n");
          out.write("\t\t");
          //  portlet:renderURL
          ...
          out.write("\t");
if (
 ddmFormAdminDisplayContext.isShowEditFormInstanceIcon(formInstance) ) {
          out.write("\n");
          out.write("\t\t");
          //  portlet:renderURL
          ...
          out.write("\t");
if (
 ddmFormAdminDisplayContext.isShowCopyFormInstanceButton() ) {
          out.write("\n");
          out.write("\t\t");
          ...
          out.write("\t");
if (
 ddmFormAdminDisplayContext.isShowExportFormInstanceIcon(formInstance) ) {
          out.write("\n");
          out.write("\t\t");
		...
		sb.append("');");
          ...
          out.write("\t");
if (
 ddmFormAdminDisplayContext.isShowPermissionsIcon(formInstance) ) {
          out.write("\n");
          out.write("\t\t");
          ...
          out.write("\t");
if (
 ddmFormAdminDisplayContext.isShowDeleteFormInstanceIcon(formInstance) ) {
          out.write("\n");
          out.write("\t\t");
          //  portlet:actionURL
