...
PortletURL portletURL = ddmFormAdminDisplayContext.getPortletURL();
      ...
      out.write("\n");
      out.write("\n");
      out.write("<div class=\"container-fluid-1280\" id=\"");
      ...
      if (_jspx_eval_aui_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_liferay$1ui_search$1container_0.setId("formInstance");
...
if (
 displayStyle.equals("descriptive") ) {
              ...
              _jspx_th_liferay$1ui_search$1container$1column$1text_0.setValue( HtmlUtil.extractText(formInstance.getName(locale)) );
              ...
              _jspx_th_liferay$1ui_search$1container$1column$1text_1.setValue( HtmlUtil.extractText(formInstance.getDescription(locale)) );
...
boolean showCSVWarning = StringUtil.equals("enabled-with-warning", csvExport);
      ...
      if (_jspx_eval_aui_script_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("exportFormInstance');\n");
          out.write("\n");
          out.write("\t\t\tvar fileExtensionSelect = A.one('#");
          ...
          out.write("\n");
          out.write("\t\t\tvar showCSVWarning = function() {\n");
          out.write("\t\t\t\tvar csvWarning = A.one('#");
          ...
          out.write("\n");
          out.write("\t\t\t\tif ((fileExtensionSelect.val() === 'csv') && ");
          out.print( showCSVWarning );
          out.write(") {\n");
          out.write("\t\t\t\t\tcsvWarning.show();\n");
          out.write("\n");
          ...
          if (_jspx_meth_portlet_namespace_8((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_1, _jspx_page_context))
            return;
          out.write("csvWarning',\n");
          out.write("\t\t\t\t\t\t\tcloseable: false,\n");
          out.write("\t\t\t\t\t\t\tcssClass: 'alert-warning',\n");
          out.write("\t\t\t\t\t\t\tdestroyOnHide: false,\n");
          out.write("\t\t\t\t\t\t\trender: true\n");
          out.write("\t\t\t\t\t\t}\n");
          out.write("\t\t\t\t\t);\n");
          out.write("\t\t\t\t}\n");
          out.write("\t\t\t\telse {\n");
          out.write("\t\t\t\t\tcsvWarning.hide();\n");
          out.write("\t\t\t\t}\n");
          out.write("\t\t\t};\n");
          out.write("\n");
          out.write("\t\t\tif (content) {\n");
          out.write("\t\t\t\tif (fileExtensionSelect) {\n");
          out.write("\t\t\t\t\tshowCSVWarning();\n");
          out.write("\n");
          out.write("\t\t\t\t\tfileExtensionSelect.on('change', showCSVWarning);\n");
          out.write("\t\t\t\t}\n");
          out.write("\n");
          ...
          out.write("\t\t\t\t\t\tcssClass: 'ddm-form-export-modal',\n");
          out.write("\t\t\t\t\t\tresizable: false,\n");
          out.write("\t\t\t\t\t\ttoolbars: {\n");
          out.write("\t\t\t\t\t\t\tfooter: [\n");
          out.write("\t\t\t\t\t\t\t\t{\n");
          out.write("\t\t\t\t\t\t\t\t\tcssClass: 'btn-secondary',\n");
          out.write("\t\t\t\t\t\t\t\t\tlabel: '");
          ...
          out.write("\t\t\t);\n");
          out.write("\t\t},\n");
          out.write("\t\t['aui-alert', 'liferay-util-window']\n");
          out.write("\t);\n");
  ...
  private boolean _jspx_meth_liferay$1ui_message_3(PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_3.setKey("copy-url");
  ...
  private boolean _jspx_meth_liferay$1ui_message_4(PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_4.setKey("copy");
  ...
  private boolean _jspx_meth_aui_script_3(PageContext _jspx_page_context)
    ...
    if (_jspx_eval_aui_script_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        if (_jspx_meth_liferay$1ui_message_7((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_3, _jspx_page_context))
          return true;
        out.write("');\n");
        out.write("\t\t}\n");
        out.write("\t);\n");
  ...
  private boolean _jspx_meth_liferay$1ui_message_5(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_script_3, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_5.setKey("copied-to-clipboard");
  ...
  private boolean _jspx_meth_liferay$1ui_message_6(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_script_3, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_6.setKey("sorry-something-wrong-happened");
  ...
  private boolean _jspx_meth_liferay$1ui_message_7(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_script_3, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  liferay-ui:message
    ...
    _jspx_th_liferay$1ui_message_7.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_script_3);
    _jspx_th_liferay$1ui_message_7.setKey("retry");
  ...
  private boolean _jspx_meth_aui_script_4(PageContext _jspx_page_context)
    ...
    if (_jspx_eval_aui_script_4 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("\tvar A = AUI();\n");
        out.write("\n");
        out.write("\tvar copyPublishFormURLPopover = new Liferay.DDM.FormBuilderCopyPublishFormURLPopover(\n");
        out.write("\t\t{\n");
        ...
        out.write("\tLiferay.on(\n");
        out.write("\t\t'");
        if (_jspx_meth_portlet_namespace_12((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_4, _jspx_page_context))
          return true;
        out.write("copyFormURL',\n");
        out.write("\t\tfunction(event) {\n");
        out.write("\n");
        out.write("\t\t\tif (copyPublishFormURLPopover.isVisible()) {\n");
        out.write("\t\t\t\tcopyPublishFormURLPopover.hide();\n");
        out.write("\t\t\t}\n");
        out.write("\n");
        out.write("\t\t\tcopyPublishFormURLPopover.set('publishURL', event.url);\n");
        out.write("\n");
        out.write("\t\t\tcopyPublishFormURLPopover.setAlign(\n");
        out.write("\t\t\t\t{\n");
        out.write("\t\t\t\t\tnode: Liferay.Menu._INSTANCE._activeTrigger,\n");
        out.write("\t\t\t\t\tpoints: [A.WidgetPositionAlign.TR, A.WidgetPositionAlign.TR]\n");
        out.write("\t\t\t\t}\n");
        out.write("\t\t\t);\n");
        out.write("\n");
        out.write("\t\t\tcopyPublishFormURLPopover.show();\n");
        out.write("\t\t}\n");
        out.write("\t);\n");
        out.write("\n");
        out.write("\tA.all('.searchcontainer-content .dropdown-toggle.icon-monospaced').before(\n");
        out.write("\t\t'click',\n");
        out.write("\t\tfunction() {\n");
        out.write("\t\t\tcopyPublishFormURLPopover.hide();\n");
        out.write("\t\t}\n");
        ...
        out.write("\t\t'destroyPortlet',\n");
        out.write("\t\tfunction() {\n");
        out.write("\t\t\tcopyPublishFormURLPopover.destroy();\n");
        out.write("\t\t}\n");
        out.write("\t);\n");
  ...
  private boolean _jspx_meth_portlet_namespace_12(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_script_4, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  portlet:namespace
    ...
    _jspx_th_portlet_namespace_12.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_script_4);
