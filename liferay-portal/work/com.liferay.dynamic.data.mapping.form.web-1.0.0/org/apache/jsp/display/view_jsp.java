...
if (
 formInstanceId == 0 ) {
      ...
      out.write("\t\t\t");
if (
 ddmFormDisplayContext.isShowSuccessPage() ) {
      out.write("\n");
      out.write("\n");
      out.write("\t\t\t\t");
      ...
      out.write("\t\t\t\t\t\t\t<h1 class=\"ddm-form-name\">");
      out.print( GetterUtil.getString(title.getString(displayLocale), title.getString(title.getDefaultLocale())) );
      out.write("</h1>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t<h5 class=\"ddm-form-description\">");
      out.print( GetterUtil.getString(body.getString(displayLocale), body.getString(body.getDefaultLocale())) );
      out.write("</h5>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
 ...
 ddmFormDisplayContext.isFormAvailable() ) {
      out.write("\n");
      out.write("\t\t\t\t");
      //  portlet:actionURL
 ...
 Validator.isNull(redirectURL) ) {
        ...
        if (_jspx_eval_liferay$1ui_error_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          do {
            ...
            _jspx_th_liferay$1ui_message_1.setArguments( msvv.getFieldName() );
        ...
        if (_jspx_eval_liferay$1ui_error_4 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          do {
            ...
            _jspx_th_liferay$1ui_message_2.setArguments( rv.getFieldName() );
        ...
        out.write("\t\t\t\t\t\t");
if (
 ddmFormDisplayContext.isFormShared() ) {
        out.write("\n");
        out.write("\t\t\t\t\t\t\t<div class=\"container-fluid-1280\">\n");
        ...
        _jspx_th_liferay$1ui_language_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_form_0);
        ...
        out.write("\t\t\t\t\t\t\t<div class=\"container-fluid-1280\">\n");
        out.write("\t\t\t\t\t\t\t\t<h1 class=\"ddm-form-name\">");
        out.print( HtmlUtil.extractText(HtmlUtil.unescape(formInstance.getName(displayLocale))) );
        out.write("</h1>\n");
        out.write("\n");
        out.write("\t\t\t\t\t\t\t\t");
...
if (
 ddmFormDisplayContext.isAutosaveEnabled() ) {
          ...
          if (_jspx_eval_liferay$1portlet_resourceURL_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            _jspx_th_portlet_param_1.setName("preview");
            _jspx_th_portlet_param_1.setValue( String.valueOf(ddmFormDisplayContext.isPreview()) );
...
if (
 ddmFormDisplayContext.isShowConfigurationIcon() ) {
      out.write("\n");
      out.write("\t<div class=\"icons-container lfr-meta-actions\">\n");
      ...
      _jspx_th_liferay$1ui_icon_0.setCssClass("lfr-icon-action lfr-icon-action-configuration");
