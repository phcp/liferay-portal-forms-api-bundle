...
if (
 themeDisplay.isSignedIn() ) {
      ...
      if (_jspx_eval_aui_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        out.write("\t\t\t\t\t");
if (
 SessionMessages.contains(request, "passwordSent") ) {
        out.write("\n");
 ...
 SessionMessages.contains(request, "userAdded") ) {
        ...
        out.write("\t\t\t\t\t\t\t\t");
if (
 company.isStrangersVerify() || Validator.isNull(userPassword) ) {
        out.write("\n");
        out.write("\t\t\t\t\t\t\t\t\t");
...
if (
 ule.passwordPolicy.isRequireUnlock() ) {
            out.write("\n");
            out.write("\t\t\t\t\t\t\t");
            if (_jspx_meth_liferay$1ui_message_7((javax.servlet.jsp.tagext.JspTag) _jspx_th_liferay$1ui_error_7, _jspx_page_context))
              return;
            out.write("\n");
            out.write("\t\t\t\t\t\t");
            out.write("\n");
        ...
        if (_jspx_eval_aui_fieldset_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          out.write("\t\t\t\t\t");
if (
 company.isAutoLogin() && !PropsValues.SESSION_DISABLED ) {
          out.write("\n");
          out.write("\t\t\t\t\t\t");
          //  aui:input
...
if (
 Validator.isNotNull(redirect) ) {
          out.write("\n");
          out.write("\t\t\t\t\t\tvar redirect = form.fm('redirect');\n");
          out.write("\n");
  ...
  private boolean _jspx_meth_liferay$1ui_message_1(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_1.setKey("your-password-was-sent-to-the-provided-email-address");
  ...
  private boolean _jspx_meth_liferay$1ui_message_7(javax.servlet.jsp.tagext.JspTag _jspx_th_liferay$1ui_error_7, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  liferay-ui:message
    ...
    _jspx_th_liferay$1ui_message_7.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1ui_error_7);
