...
SiteNavigationMenuDisplayContext siteNavigationMenuDisplayContext = new SiteNavigationMenuDisplayContext(request);
      ...
      out.write('	');
if (
 (SiteNavigationMenuLocalServiceUtil.getSiteNavigationMenusCount(scopeGroupId) > 0) && (siteNavigationMenuDisplayContext.getSiteNavigationMenuType() > 0) && (siteNavigationMenuDisplayContext.getSiteNavigationMenuId() <= 0) ) {
      out.write("\n");
 ...
 (siteNavigationMenuDisplayContext.getSiteNavigationMenuType() == -1) && (siteNavigationMenuDisplayContext.getSiteNavigationMenuId() <= 0) ) {
      out.write("\n");
      ...
      _jspx_th_liferay$1site$1navigation_navigation$1menu_0.setSiteNavigationMenuId( siteNavigationMenuDisplayContext.getSiteNavigationMenuId() );
