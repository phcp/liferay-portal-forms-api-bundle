...
AssetHelper assetHelper = (AssetHelper)request.getAttribute(AssetWebKeys.ASSET_HELPER);
	...
	String portletNamespace = PortalUtil.getPortletNamespace(ProductNavigationControlMenuPortletKeys.PRODUCT_NAVIGATION_CONTROL_MENU);
          ...
          out.write("\n");
          out.write("\n");
          out.write("\t<div class=\"closed hidden-print lfr-add-panel lfr-admin-panel sidenav-fixed sidenav-menu-slider sidenav-right\" id=\"");
          out.print( portletNamespace );
          out.write("addPanelId\">\n");
          out.write("\t\t<div class=\"product-menu sidebar sidebar-inverse sidenav-menu\">\n");
          ...
          if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              out.write("\n");
              out.write("\t\tvar addToggle = $('#");
              out.print( portletNamespace );
              out.write("addToggleId');\n");
              out.write("\n");
              out.write("\t\taddToggle.sideNavigation();\n");
              out.write("\n");
              out.write("\t\tLiferay.once(\n");
              out.write("\t\t\t'screenLoad',\n");
              out.write("\t\t\tfunction() {\n");
              out.write("\t\t\t\tvar sideNavigation = addToggle.data('lexicon.sidenav');\n");
              out.write("\n");
  ...
  private boolean _jspx_meth_aui_icon_0(javax.servlet.jsp.tagext.JspTag _jspx_th_liferay$1util_body$1bottom_0, PageContext _jspx_page_context)
    ...
    _jspx_th_aui_icon_0.setCssClass("icon-monospaced sidenav-close");
