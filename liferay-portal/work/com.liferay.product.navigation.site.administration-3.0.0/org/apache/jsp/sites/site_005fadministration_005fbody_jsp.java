...
if (
 siteAdministrationPanelCategoryDisplayContext.isShowStagingInfo() ) {
      ...
      out.write("\n");
      out.write("\n");
      out.write("\t\t\t\t<div class=\"pull-right staging-links\">\n");
...
if (
 siteAdministrationPanelCategoryDisplayContext.isDisplaySiteLink() ) {
      ...
      _jspx_th_aui_a_3.setCssClass("goto-link list-group-heading");
  ...
  private boolean _jspx_meth_aui_script_0(PageContext _jspx_page_context)
    ...
    if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("\t\t\t\t\t\t\t\t{\n");
        out.write("\t\t\t\t\t\t\t\t\tbodyContent: Liferay.Language.get('the-connection-to-the-remote-live-site-cannot-be-established-due-to-a-network-problem'),\n");
